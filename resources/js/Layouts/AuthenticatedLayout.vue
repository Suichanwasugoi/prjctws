...
<template>
    <div>
        <div class="min-h-screen bg-purple-400">
            <nav class="bg-violet-300 border-b border-violet-500">
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-violet-700 focus:outline-none focus:bg-violet-100 focus:text-violet-500 transition duration-150 ease-in-out"
                            >
